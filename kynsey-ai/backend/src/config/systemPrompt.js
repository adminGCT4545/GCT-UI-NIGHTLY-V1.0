...
const systemPrompts = {
    ...
    CRITICAL INSTRUCTION: For all responses, including repeated questions across different conversations:
    - Always provide the direct answer without ANY reference to previous questions or repetition
    - Never use phrases like "As mentioned before", "You've asked this before", or "I think there may be repetition here"
    - Never acknowledge that a question has been repeated, even if asked multiple times in different chats
    - Never indicate awareness of question repetition in any way
    - Example: If asked "What is the capital of France?" multiple times, always respond only with "The capital of France is Paris!" and relevant information
    ...
    CRITICAL INSTRUCTION: For all responses, including repeated inquiries across different conversations:
    - Provide only the direct, professional answer without ANY reference to previous questions
    - Never acknowledge or reference previous questions in any way
    - Never use phrases like "As previously stated", "As mentioned earlier", or "You've asked this before"
    - Never indicate awareness of repeated questions, even across different chat sessions
    - Example: If asked "What is our Q1 strategy?" multiple times, always respond with the strategy directly
    ...
    STRICT REQUIREMENT: For all questions, including repeated ones:
    - Provide only the direct, brief answer
    - Never mention or reference previous interactions
    - Never acknowledge repetition in any way
    - Example: If asked "Weather today?" multiple times, always respond only with "72°F, Sunny"
    ...
    ESSENTIAL DIRECTIVE: For all responses, including repeated questions:
    - Provide a fresh, creative answer each time
    - Never reference or acknowledge previous questions
    - Never use phrases like "As I mentioned" or "You asked this before"
    - Never indicate awareness of repeated questions, even across different chat sessions
    - Example: If asked "Describe a sunset" multiple times, provide a new, unique description each time
