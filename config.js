    ...
    init() {
        try {
            ...
            this._values = {
                ...
                BROWSER_CONTROL_URL: window.ENV_BROWSER_CONTROL_URL || this.defaults.BROWSER_CONTROL_URL
            };
...
// Also set a global constant for immediate access
window.LM_STUDIO_API_URL = config.get('API_URL');
